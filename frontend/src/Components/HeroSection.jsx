  ...
  return (
    <div className=" max-w-screen-xl w-full grid grid-cols-3 gap-4 shadow-xl p-3 rounded-xl">
      <section className="col-span-3 sm:col-span-2 relative">
        {/* Big Featured */}
        <section className="absolute w-full h-full top-0 left-0 rounded-md p-16 text-white ">
          <p className="text-xs">HIGH QUALITY FRESH FOODS</p>
          <p className="text-4xl font-extrabold">Order Today</p>
          <p className="text-xs">Tasty Products for delightful meals.</p>
      ...
      <aside className="flex col-span-3 sm:col-span-1 sm:flex-col gap-4">
        <section className="relative">
          ...
          <section className="absolute w-full h-full top-0 left-0 rounded-md p-5 text-black cursor-pointer">
            ...
            <p className="text-xs">Only Fruits & Veggies</p>

            {/* Add a parameter to this link so you can filter only fruits and veggies */}
            <Link to="/shop">
              <p className="text-xs mt-4 w-fit hover:rounded-xl text-[#00B207] hover:bg-[#00B207] hover:p-2 hover:text-white transition-all ease-in-out">
                Show Now
              </p>
            </Link>
          </section>
        ...
        <section className="relative">
          <section className="absolute w-full h-full top-0 left-0 bg-black opacity-0 hover:opacity-60 transition-opacity ease-out duration-200 rounded-md text-center flex flex-col justify-center cursor-pointer">
            ...
            <p className="opacity-100 text-white text-xl font-extrabold">
              Special Products
            </p>
            <p className="opacity-100 text-white text-xl font-extrabold">
              Deal of the Month
